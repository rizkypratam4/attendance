    ...
    <thead>
        <tr style="border-bottom:1px solid var(--border)">
            ...
            <th class="text-left px-4 py-3 font-semibold"
                style="font-size:11px;color:#7c3aed;letter-spacing:.08em;text-transform:uppercase">Nama Lengkap
            </th>
            <th class="text-left px-4 py-3 font-semibold"
                style="font-size:11px;color:#7c3aed;letter-spacing:.08em;text-transform:uppercase">NIK
            </th>
            <th class="text-left px-4 py-3 font-semibold"
                style="font-size:11px;color:#7c3aed;letter-spacing:.08em;text-transform:uppercase">Departemen
            </th>
            <th class="text-left px-4 py-3 font-semibold"
                style="font-size:11px;color:#7c3aed;letter-spacing:.08em;text-transform:uppercase">Posisi</th>
            ...
            <tr class="emp-row" style="border-bottom:1px solid var(--border)"
                ...
                <td class="px-5 py-3.5 text-right">
                    ...
                    <button class="act-trigger ib-bg w-8 h-8 rounded-lg flex items-center justify-center ml-auto"
                        data-entity="employee" data-name="{{ $employee->name }}" data-nik="{{ $employee->nik }}"
                        data-machine-barcode="{{ $employee->machine_barcode }}"
                        data-branch-id="{{ $employee->branch_id }}"
                        data-department-id="{{ $employee->department_id }}" data-position="{{ $employee->position }}"
                        ...
                        data-is-active="{{ $employee->is_active }}" data-delete-id="{{ $employee->id }}"
