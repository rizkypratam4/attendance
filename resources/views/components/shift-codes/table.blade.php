    ...
    <thead>
        <tr style="border-bottom:1px solid var(--border)">
            <th class="text-left px-5 py-3 font-semibold whitespace-nowrap"
                style="font-size:11px;color:var(--text-3);letter-spacing:.08em;text-transform:uppercase;width:100px">
                Shift Code</th>
            <th class="text-left px-4 py-3 font-semibold whitespace-nowrap"
                style="font-size:11px;color:var(--text-3);letter-spacing:.08em;text-transform:uppercase">Description</th>
            <th class="text-left px-4 py-3 font-semibold whitespace-nowrap"
                style="font-size:11px;color:var(--text-3);letter-spacing:.08em;text-transform:uppercase">Schedule</th>
            <th class="text-left px-4 py-3 font-semibold whitespace-nowrap"
                style="font-size:11px;color:var(--text-3);letter-spacing:.08em;text-transform:uppercase">Break</th>
            <th class="text-left px-4 py-3 font-semibold whitespace-nowrap"
                style="font-size:11px;color:var(--text-3);letter-spacing:.08em;text-transform:uppercase">Color Tag</th>
            <th class="text-left px-4 py-3 font-semibold whitespace-nowrap"
                style="font-size:11px;color:var(--text-3);letter-spacing:.08em;text-transform:uppercase">Status</th>
            <th class="text-right px-5 py-3 font-semibold whitespace-nowrap"
                style="font-size:11px;color:var(--text-3);letter-spacing:.08em;text-transform:uppercase">Actions</th>
        </tr>
    </thead>
    <tbody>
        {{-- Morning Shift --}}
        <tr class="shift-row" data-code="M-01" data-name="Morning Shift" data-status="active"
            style="border-bottom:1px solid var(--border)">
            <td class="px-5 py-4">
                <span class="px-2.5 py-1.5 rounded-lg font-bold"
                    style="font-size:12px;background:rgba(59,130,246,.2);color:#60a5fa;letter-spacing:.04em">M-01</span>
            </td>
            <td class="px-4 py-4">
            ...
            <td class="px-5 py-4 text-right">
                <div class="flex items-center justify-end gap-2">
                    <button
                        onclick="openEditShift('M-01','Morning Shift','Standard general morning','08:00 AM','05:00 PM','60','#3b82f6','active')"
