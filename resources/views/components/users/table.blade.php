    ...
    <thead>
        <tr style="border-bottom:1px solid var(--border)">
            <th class="text-left px-5 py-3 font-semibold"
                style="font-size:11px;color:#7c3aed;letter-spacing:.08em;text-transform:uppercase">Username</th>
            ...
            <tr class="user-row" style="border-bottom:1px solid var(--border)">
                ...
                <td class="px-4 py-3.5">
                    <div class="flex items-center gap-2">
                        ...
                        @if($user->status)
                            <span class="text-green-400" style="font-size:13.5px">Active</span>
                        @else
                            <span class="text-gray-400" style="font-size:13.5px">Inactive</span>
                        @endif
                    </div>
                </td>
