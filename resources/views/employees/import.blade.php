<x-ui.modal id="mImportEmployee" title="Impor Karyawan" maxWidth="480px">
        ...
        <div class="space-y-4">
            <div>
                ...
                <div class="border-2 border-dashed rounded-lg p-6 text-center cursor-pointer transition"
                    ...
                    <p id="fileName" style="font-size:14px;color:var(--text-2);margin:0">Pilih file atau seret ke sini</p>
