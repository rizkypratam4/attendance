...
@section('content')
    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
        <div>
            ...
            <p style="font-size:13px;color:var(--text-3);margin-top:5px">
                Konfigurasi lokasi kerja fisik dan parameter pembatasan wilayah (geofencing).
            </p>
        </div>

        <button onclick="openM('mAddLocation')"
            class="purbtn inline-flex self-start items-center gap-2 px-4 py-2.5 rounded-xl font-semibold"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-5">
        <x-stat-card title="Total Lokasi" :value="$totalLocations" subtitle="" subtitleColor="#7c3aed">
        ...
        <x-stat-card title="Lokasi Aktif" :value="$activeLocations" subtitle="" subtitleColor="#16a34a">
        ...
        <x-stat-card title="Rincian Tipe" :value="$typeSummary" subtitle="" subtitleColor="#f59e0b">
    ...
    <x-ui.card class="overflow-hidden">
        <div class="flex items-center gap-3 px-5 py-4" style="border-bottom:1px solid var(--border)">
            ...
            <h2 style="font-size:15px;font-weight:700;color:var(--text-1)">Tampilan Geografis Visual</h2>
        </div>
