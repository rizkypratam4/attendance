...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
        <div>
            ...
            <p style="font-size:13px;color:var(--text-3);margin-top:5px">
                Kelola dan atur grup shift kerja organisasi Anda secara efisien.
            </p>
        </div>
    ...
    {{-- Table --}}
    <x-shift-groups.table :shiftGroups="$shiftGroups" :current-page="$currentPage" :total-pages="$totalPages" :from="$from" :to="$to"
        :total="$total" />
