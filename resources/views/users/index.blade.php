...
@section('content')
    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
        <div>
            <h1 style="font-size:24px;font-weight:800;color:var(--text-1);line-height:1.2">User Accounts</h1>
            <p style="font-size:13px;color:var(--text-3);margin-top:5px">Manage, edit and monitor all registered accounts in
                your system.</p>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-5">
        <x-ui.stat-card title="Total Users" :value="number_format($totalUsers)" meta="+12%">
            <x-slot:icon>
